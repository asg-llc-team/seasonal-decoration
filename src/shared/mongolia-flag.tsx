/** Mongolia state flag per MNS 6262:2011 (Wikimedia Commons Flag_of_Mongolia.svg). */
export function MongoliaFlag({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d='M0 0h1200v600H0z' fill='#da2031' />
      <path d='M400 0h400v600H400z' fill='#0066b2' />
      <circle cx='200' cy='205' r='55' />
      <circle cx='200' cy='180' r='60' fill='#da2031' />
